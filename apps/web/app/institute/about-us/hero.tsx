      ...
      <div className="mx-auto w-full max-w-[1871px]">
        ...
        >
          <div className="absolute inset-0 z-0 bg-[#0e1b33]">
            <Image
              src="/images/institute/hero/about-us.png"
              alt="About Castor Health Institute"
              fill
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, rgba(14, 27, 51, 0.90) 0%, rgba(0, 0, 0, 0.00) 100%)",
              }}
            />
          </div>
          ...
          <div className="relative z-20 flex h-full items-center justify-start px-7 sm:px-10 md:px-14 lg:px-20 xl:px-24">
            <div className="flex max-w-[42rem] flex-col gap-6 pt-6 lg:pt-0">
              ...
              >
                You heard us — CNA, Phlebotomy, CPR, and Dual Enrollment classes
                are now coming to downtown Freeport! See our schedules and enroll
                now.
              </motion.p>
            </div>
          </div>
