...
import { FileText, Award, Droplet, GraduationCap } from "lucide-react";

const curriculumItems = [
  { id: 1, title: "Anatomy & Physiology", duration: "24 hours" },
  { id: 2, title: "Venipuncture Techniques", duration: "40 hours" },
  { id: 3, title: "Capillary Collection", duration: "16 hours" },
  { id: 4, title: "Safety & Infection Control", duration: "20 hours" },
  { id: 5, title: "Clinical Practicum", duration: "40 hours" },
];

const featureCards = [
  {
    title: "Real-World Practice",
    description: "Practice venipuncture on training arms and participate in clinical externships at partner healthcare facilities.",
    icon: Droplet,
    variant: "teal",
  },
  {
    title: "National Certification",
    description: "Prepare for the CPT1 (Certified Phlebotomy Technician) national certification exam with our comprehensive training.",
    icon: Award,
    variant: "white",
  },
  {
    title: "Career Support",
    description: "Access our job board and career counseling to find positions in hospitals, labs, and blood donation centers.",
    icon: GraduationCap,
    variant: "peach",
  },
];

export default function PhlebotomyCurriculum() {
  const fadeInUp = {
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-[#6a6a67]">
              Learn essential phlebotomy skills from experienced professionals in our state-of-the-art training facility.
            </p>
