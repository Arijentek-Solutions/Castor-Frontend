...
const highlights = [
  {
    title: "Earn college credits early",
  },
  {
    title: "No tuition cost to students",
  },
  {
    title: "Small class sizes",
  },
  {
    title: "Transfer credits to college",
  },
  {
    title: "Hands-on healthcare training",
  },
  {
    ...
    <section className="bg-white px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="text-center">
          ...
          >
            Start your healthcare career while still in high school. Earn credits, gain experience, and get ahead.
          </motion.p>
        </div>
