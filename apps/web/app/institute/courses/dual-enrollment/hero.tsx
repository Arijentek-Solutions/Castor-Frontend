          ...
          <div className="relative z-10 mx-auto px-6 py-12 flex flex-col-reverse lg:flex-row lg:h-[700px] lg:items-center lg:justify-between lg:px-20">
            ...
            <div className="max-w-3xl lg:w-[55%]">
              ...
              <div>
                ...
                >
                  Dual <br />
                  <span className="text-[#20a9ad]">Enrollment</span>
                </motion.h1>
              </div>
              ...
              >
                Earn college credits while still in high school. Our dual enrollment program
                allows you to get a head start on your healthcare career with courses that count
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-medium text-white">1-2 Semesters</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-white/40">Next Session</span>
                    <span className="text-sm font-medium text-white">Fall 2026</span>
                  </div>
                </div>
              </motion.div>
