  ...
  return (
    <section className="px-4 pb-14 pt-48 sm:px-6 sm:pt-52 lg:px-8 lg:pb-20 lg:pt-48">
      <div className="mx-auto w-full max-w-[1871px]">
        ...
        >
          <div className="relative z-10 mx-auto flex flex-col-reverse items-start px-8 py-12 sm:items-center sm:py-16 sm:px-12 lg:flex-row lg:justify-between lg:py-16 lg:px-16">
