        ...
        <div className="w-full md:w-1/2 flex flex-col items-start space-y-6 md:py-6">
          <div className="space-y-4 w-full">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 bg-[#ffead8] px-4 py-2 rounded-full"
            >
          ...
          >
            {benefits.map((benefit, i) => (
              <motion.li 
                ...
                className="flex gap-3 items-center text-[#6A6A67] text-base leading-6"
              >
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="mt-2 inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full text-white font-bold text-lg transition-transform"
            style={{
