...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-white font-sans">
      <main className="w-full pt-[132px] lg:pt-[168px]">
        <Navbar
        ...
        {/* Product Catalog Layout - Seamless Integration */}
        <div className="mx-auto max-w-[1720px] px-6 pt-3 pb-20 sm:px-8 lg:px-12 lg:pt-4">
          <div className="flex flex-col gap-8 lg:flex-row">

            {/* Sticky & Scrollable Sidebar - Desktop Only */}
            <div className="hidden shrink-0 lg:sticky lg:top-[280px] lg:h-fit lg:w-[360px] lg:block">
              <Sidebar
                categories={categories}
                selectedCategory={selectedCategory}
                onCategoryChange={handleCategoryChange}
