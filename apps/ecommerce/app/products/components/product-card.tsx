...
export function ProductCard({ product }: ProductCardProps) {
  ...
  const handlePricingRequest = (e: React.MouseEvent | React.KeyboardEvent) => {
    e.preventDefault();
    e.stopPropagation();
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-[1.25rem] border border-slate-100 bg-white p-3 shadow-sm transition-all hover:border-[#20a9ad]/30 hover:shadow-xl lg:rounded-[2rem] lg:p-6">
      ...
      <div className="flex h-44 w-full flex-row md:h-44 lg:hidden relative z-[2]">
        ...
        <div className="relative h-full w-[45%] shrink-0 overflow-hidden rounded-xl bg-slate-50 md:rounded-2xl">
          ...
          {product.insuranceCovered && (
            <div className="absolute top-1 left-1 flex items-center gap-0.5 rounded-md bg-[#f0fdf4] border border-[rgba(0,130,54,0.2)] px-1.5 py-0.5">
              <ShieldCheck size={12} className="text-[#008236]" aria-hidden="true" />
        ...
        <div className="flex flex-1 flex-col justify-between pl-3 md:pl-4">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              <div className="text-[11px] font-bold uppercase tracking-[0.3px] text-[#20a9ad]">
                {product.sku}
              </div>
              {product.hcpcs && (
            ...
            <h3 className="line-clamp-1 text-[13px] font-semibold leading-tight text-[#0e1b33]">
              {product.name}
            </h3>
            ...
            <div className="flex items-center gap-1" aria-label={`${product.rating} out of 5 stars`}>
              ...
              <span className="text-[10px] font-medium text-[#6a6a67]">({product.reviewCount})</span>
            </div>
          </div>
          ...
          <div className="flex flex-1 items-end justify-between">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="relative z-[3] flex h-7 w-7 items-center justify-center rounded-full bg-[#20a9ad] text-white shadow-lg shadow-[#20a9ad]/20 transition-all duration-300 hover:scale-110 hover:shadow-[#20a9ad]/40 active:scale-95 focus-visible:outline-2 focus-visible:outline-[#20a9ad] focus-visible:outline-offset-2"
              ...
              {product.workflowType === "pricing-request" ? (
                <button
                  ...
                  onKeyDown={(e) => handleKeyDown(e, handlePricingRequest)}
                  className="relative z-[3] flex h-7 items-center rounded-full bg-[#F7C89A] px-3 text-[11px] font-bold text-[#0e1b33] shadow-lg shadow-[#F7C89A]/20 transition-all duration-300 hover:scale-105 hover:bg-[#eeb67a] hover:shadow-[#F7C89A]/40 active:scale-95 focus-visible:outline-2 focus-visible:outline-[#20a9ad] focus-visible:outline-offset-2"
                  aria-label={`Request pricing for ${product.name}`}
                >
                  Call
                </button>
              ) : (
                <button
                  ...
                  className="relative z-[3] flex h-7 items-center rounded-full bg-[#0e1b33] px-3 text-[11px] font-bold text-white shadow-lg shadow-[#0e1b33]/20 transition-all duration-300 hover:scale-105 hover:bg-[#0e1b33]/90 hover:shadow-[#0e1b33]/40 active:scale-95 focus-visible:outline-2 focus-visible:outline-[#20a9ad] focus-visible:outline-offset-2"
      ...
      <div className="hidden flex-col gap-4 lg:flex relative z-[2]">
        {/* Product Image */}
        <div className="relative aspect-square w-full overflow-hidden rounded-2xl bg-slate-50">
          ...
          {product.insuranceCovered && (
            <div className="absolute top-2 left-2 flex items-center gap-1 rounded-md bg-[#f0fdf4] border border-[rgba(0,130,54,0.2)] px-2.5 py-1.5">
              <ShieldCheck size={18} className="text-[#008236]" aria-hidden="true" />
          ...
          <div className="mt-1 flex items-center justify-between gap-2 border-t border-[rgba(32,169,173,0.1)] pt-5">
            <div className="flex items-center gap-3">
              <button
                type="button"
                onClick={handleAddToCart}
                className="relative z-[3] flex h-12 w-12 items-center justify-center rounded-full bg-[#20a9ad] text-white shadow-lg shadow-[#20a9ad]/20 transition-all duration-300 hover:scale-110 hover:shadow-[#20a9ad]/40 active:scale-95 focus-visible:outline-2 focus-visible:outline-[#20a9ad] focus-visible:outline-offset-2"
                aria-label={`Add ${product.name} to cart`}
              >
            ...
            <div className="flex items-center gap-2">
              {product.workflowType === "pricing-request" ? (
                <button
                  ...
                  onClick={handlePricingRequest}
                  onKeyDown={(e) => handleKeyDown(e, handlePricingRequest)}
                  className="relative z-[3] flex h-12 items-center rounded-full bg-[#F7C89A] px-10 text-[13px] font-bold text-[#0e1b33] shadow-lg shadow-[#F7C89A]/20 transition-all duration-300 hover:scale-105 hover:bg-[#eeb67a] hover:shadow-[#F7C89A]/40 active:scale-95 focus-visible:outline-2 focus-visible:outline-[#20a9ad] focus-visible:outline-offset-2"
                  aria-label={`Request pricing for ${product.name}`}
                >
                  Call for Pricing
                </button>
                ...
                <button
                  ...
                  onClick={handleBuyNow}
                  onKeyDown={(e) => handleKeyDown(e, handleBuyNow)}
                  className="relative z-[3] flex h-12 items-center rounded-full bg-[#0e1b33] px-10 text-[13px] font-bold text-white shadow-lg shadow-[#0e1b33]/20 transition-all duration-300 hover:scale-105 hover:bg-[#0e1b33]/90 hover:shadow-[#0e1b33]/40 active:scale-95 focus-visible:outline-2 focus-visible:outline-[#20a9ad] focus-visible:outline-offset-2"
                  aria-label={`Buy ${product.name} now`}
                >
                  Buy
                </button>
